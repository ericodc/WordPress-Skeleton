	...
	<footer id="contact" class="site-footer template-wrap" role="contentinfo">
		...
		<div class="site-info">
			...
			<div class="copyright">
				...
				<br>
				Also check: <a href="http://www.enginethemes.com/themes/directoryengine" target="_blank">WordPress Directory Theme</a>. By <a href="http://www.enginethemes.com"  target="_blank">EngineThemes</a>.
			</div>			
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
	<?php } ?>
